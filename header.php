...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><strong class="titre">PARCOURS LE MONDE IDF</strong></a>&nbsp;
        <a class="navbar-brand" href="index.php"><img src="img/logo.png" class="rounded rounded-3" alt="Parcours Le Monde"></a>
