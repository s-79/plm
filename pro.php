...
<div class="row justify-content-center mt-5" style="margin-top: 5em !important;">
    ...
    <div class="col-12 col-lg-2 my-4 mx-1 text-center">
        ...
        <label for="dtv" class="d-none">Saisir le prénom, l'organisme ou la ville</label>
    </div>
...
<div class="row justify-content-center ">
    ...
    <div class="col-12 col-lg-3 bg-marine m-3 rounded rounded-3">
        <div class="row pt-4">
            ...
            <div class="col-1 p-0 m-0">
                <i id="new_pro" class="fas fa-plus-circle fa-2x text-white pointeur" data-toggle="tooltip" data-placement="top" title="Créer un nouvel événement"></i>
            </div>
        </div>
    ...
    <div class="col-12 col-lg-3 bg-marine m-3 rounded rounded-3">
        ...
        <div id="btn_pro_create" class="form-group d-flex justify-content-center mx-3 mt-1 mb-2">
            <button type="button" id="pro_create" class="btn btn-primary bg-bleu btn-bleu marine m-3">&nbsp;Enregistrer&nbsp;<br>la fiche</button>
        </div>
        <div id="btn_pro_update" class="form-group d-flex justify-content-center mx-3 mt-1 mb-2 d-none">
