    ...
    <div class="d-flex justify-content-center" style="margin-top: 3.5em !important;">
        <div class="row search_bar">
            ...
            <div class="col-12 col-sm-6 col-lg-3 py-4 pr-1 pl-3 text-center">
                <input type="text" class="form-control" id="prj_search" placeholder="Saisir l'intitulé, le pays ou la période">
                <label for="prj_search" class="d-none">Saisir l'intitulé, le pays ou la période</label>
            </div>
            ...
            <div class="col-6 col-lg-3 py-4 px-1 text-left">
                <button type="button" id="periode" class="btn btn-warning">Calendrier des projets <i class="far fa-calendar-alt fa-lg ps-2"></i></button>
            </div>
        </div>
    </div>
    ...
    <form id="form_prj">
        <div class="d-flex justify-content-center">
            <div class="row formulaires">
                ...
                <div class="col-12 col-lg-6 col-xl-4">
                    <div class="bg-marine m-3 py-2 px-3 rounded rounded-3 div_marine">
                        <h2 class="pt-3">Période & Détails</h2>
                ...
                <div class="col-12 col-lg-6 col-xl-4">
                    <div class="bg-marine m-3 py-2 px-3 rounded rounded-3 div_marine">
                        <h2 class="pt-3">Échange de jeunes</h2>
                        <div class="form-floating mx-3 mt-4">
                        ...
                        <div id="btn_prj_create" class="form-group d-flex justify-content-center mx-3 mt-2">
                            <button type="button" id="prj_create" class="btn btn-primary btn-bleu m-3">&nbsp;Enregistrer&nbsp;<br>la fiche</button>
                        </div>
                        <div id="btn_prj_update" class="form-group d-flex justify-content-center mx-3 mt-2 d-none">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="btn_part_create" type="button" class="btn btn-primary btn-bleu close-modal" data-bs-toggle="modal" data-bs-target="#modal_part_create">Ajouter</button>
...
<div class="modal fade" id="modal_part_create" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id="part_create" type="button" class="btn btn-primary btn-bleu">Ajouter</button>
            </div>
        </div>
    </div>
</div>
