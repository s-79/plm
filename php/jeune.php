...
if($id_del) {
    ...
    $query = "CALL jeune_Update('$id', '$genre', '$prenom', '$nom', '$ddn', '$nationalite', '$adherent', '$email', '$tel', '$facebook', '$skype', '$insta', '$urgence',
    '$adresse', '$id_ville', '$qpv', '$id_qpv', '$id_orga', '$nom_ref', '$tel_ref', '$email_ref', '$ml', '$gj',
    '$formation', '$niveau', '$diplome', '$niveau_anglais', '$langues', '$at_anglais', '$statut', '$pe', '$rsa', '$id_evt')";

} else {
    $query = "CALL jeune_Create ('$genre', '$prenom', '$nom', '$ddn', '$nationalite', '$adherent', '$email', '$tel', '$facebook', '$skype', '$insta', '$urgence',
    '$adresse', '$id_ville', '$qpv', '$id_qpv', '$id_orga', '$nom_ref', '$tel_ref', '$email_ref', '$ml', '$gj',
    '$formation', '$niveau', '$diplome', '$niveau_anglais', '$langues', '$at_anglais', '$statut', '$pe', '$rsa', '$id_evt')";
}
